    ...
    ) : void 
{
    ...
    for (const abilitiy of coin.abilities) // abilities가 ability의 배열이니 foreach로 내용물 확인
    { 
        ...
        if (logic) {
            ...
            console.log(logic, actualTarget, abilitiy.data, damage)
        }
    }
}
